...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = LeeColor(0,0,0,1);
    }
    return self;
}
...
- (void)setupToolbars
{
    ...
    indexLabel.backgroundColor = LeeColor(0,0,0,0.3);
    ...
    saveButton.backgroundColor = LeeColor(0,0,0,0.3);
...
- (void)show
{
    ...
    _contentView.backgroundColor = LeeColor(0,0,0,1);
...
//        NSLog(@"onDeviceOrientationChange");
        [UIView animateWithDuration:kAnimationDuration delay:0.0f options:UIViewAnimationOptionBeginFromCurrentState animations:^{
            [kApplication setStatusBarOrientation:(UIInterfaceOrientation)orientation];
