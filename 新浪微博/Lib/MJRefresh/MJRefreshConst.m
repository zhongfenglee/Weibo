...
NSString *const MJRefreshHeaderIdleText = @"下拉刷新";// 下拉可以刷新
NSString *const MJRefreshHeaderPullingText = @"释放更新";// 松开立即刷新
NSString *const MJRefreshHeaderRefreshingText = @"加载中";// 正在刷新数据中...

NSString *const MJRefreshAutoFooterIdleText = @"更多";// 点击或上拉加载更多
NSString *const MJRefreshAutoFooterRefreshingText = @"加载中";// 正在加载更多的数据...
